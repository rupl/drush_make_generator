<?php
  ...
  define('ANALYTICS_ACCOUNT', 'UA-432773-12');
?>
<!doctype html>
<html lang="en-US">
<head>
  <meta charset="utf-8">
  <title>DrushMake.me is temporarily disabled :(</title>
...
<body class="container_12">
  ...
  <div class="grid_12" id="generate">
    <h1>Unfortunately</h1>
    <p>This site got hacked and given recent Drupal security problems I cannot keep it up right now. Sorry!</p>
    <p>The source code has and always will be free, so you can set up your own instance: <a href="https://github.com/rupl/drush_make_generator">Code hosted on GitHub.</a></p>
    <p>oo00OO0000ooooorrrrr..... <a href="https://github.com/mattgrill/drushmakejs">contribute here</a> and we'll get a new, improved version running eventually.</p>
  </div>
